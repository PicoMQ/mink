...
<template>
  <h1 class="heading">
    <span class="text">
      Streaming storage on<br />
      <span ref="rotor" class="mink-hero-rotor">object storage</span>
    </span>
  </h1>
  <p class="tagline">
    Mink is lakehouse-native streaming storage. Kafka and Arrow Flight in,<br />
    open table formats out, hot and cold served as one table.
  </p>
</template>
